...
payasosVendidos = int(input("Introduce el total de payasos vendidos: "))
muniecasVendidas = int(input("Introduce el total de muñecas vendidas: "))

total = (payasosVendidos * pesoPayaso) + (muniecasVendidas * pesoMunieca)

print("El peso total del del paquete es de",total)
